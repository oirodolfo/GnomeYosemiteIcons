...
wget https://github.com/zangent/GnomeYosemiteIcons/archive/master.zip
unzip -o master.zip
else
echo Cloning from GitHub repository.
git clone https://github.com/zangent/GnomeYosemiteIcons.git GnomeYosemiteIcons-master
fi
